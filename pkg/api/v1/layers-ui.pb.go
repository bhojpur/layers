...
func (x *ListEngineSpecsRequest) Reset() {
	*x = ListEngineSpecsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_layers_ui_proto_msgTypes[0]
...
func (*ListEngineSpecsRequest) Descriptor() ([]byte, []int) {
	return file_layers_ui_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListEngineSpecsResponse) Reset() {
	*x = ListEngineSpecsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_layers_ui_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListEngineSpecsResponse) Descriptor() ([]byte, []int) {
	return file_layers_ui_proto_rawDescGZIP(), []int{1}
}
...
func (x *DesiredAnnotation) Reset() {
	*x = DesiredAnnotation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_layers_ui_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DesiredAnnotation) Descriptor() ([]byte, []int) {
	return file_layers_ui_proto_rawDescGZIP(), []int{2}
}
...
func (x *IsReadOnlyRequest) Reset() {
	*x = IsReadOnlyRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_layers_ui_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*IsReadOnlyRequest) Descriptor() ([]byte, []int) {
	return file_layers_ui_proto_rawDescGZIP(), []int{3}
}
...
func (x *IsReadOnlyResponse) Reset() {
	*x = IsReadOnlyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_layers_ui_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*IsReadOnlyResponse) Descriptor() ([]byte, []int) {
	return file_layers_ui_proto_rawDescGZIP(), []int{4}
}
...
var File_layers_ui_proto protoreflect.FileDescriptor

var file_layers_ui_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x2d, 0x75, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x02, 0x76, 0x31, 0x1a, 0x0c, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x2e, 0x70, 0x72,
	...
	0x61, 0x79, 0x65, 0x72, 0x73, 0x55, 0x49, 0x12, 0x4e, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x45,
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x68, 0x6f, 0x6a, 0x70, 0x75, 0x72, 0x2f, 0x6c, 0x61, 0x79,
	0x65, 0x72, 0x73, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_layers_ui_proto_rawDescOnce sync.Once
	file_layers_ui_proto_rawDescData = file_layers_ui_proto_rawDesc
)

func file_layers_ui_proto_rawDescGZIP() []byte {
	file_layers_ui_proto_rawDescOnce.Do(func() {
		file_layers_ui_proto_rawDescData = protoimpl.X.CompressGZIP(file_layers_ui_proto_rawDescData)
	})
	return file_layers_ui_proto_rawDescData
}

var file_layers_ui_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_layers_ui_proto_goTypes = []interface{}{
...
var file_layers_ui_proto_depIdxs = []int32{
	...
	0, // 2: v1.LayersUI.ListEngineSpecs:input_type -> v1.ListEngineSpecsRequest
	3, // 3: v1.LayersUI.IsReadOnly:input_type -> v1.IsReadOnlyRequest
	1, // 4: v1.LayersUI.ListEngineSpecs:output_type -> v1.ListEngineSpecsResponse
	4, // 5: v1.LayersUI.IsReadOnly:output_type -> v1.IsReadOnlyResponse
...
func init() { file_layers_ui_proto_init() }
func file_layers_ui_proto_init() {
	if File_layers_ui_proto != nil {
		return
	}
	file_layers_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_layers_ui_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_layers_ui_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_layers_ui_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_layers_ui_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_layers_ui_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_layers_ui_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_layers_ui_proto_goTypes,
		DependencyIndexes: file_layers_ui_proto_depIdxs,
		MessageInfos:      file_layers_ui_proto_msgTypes,
	}.Build()
	File_layers_ui_proto = out.File
	file_layers_ui_proto_rawDesc = nil
	file_layers_ui_proto_goTypes = nil
	file_layers_ui_proto_depIdxs = nil
}
